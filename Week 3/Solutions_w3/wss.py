...
def wss_run(*args):
                ...
                for symbol in insIds:
                    ...
                    for sig in Signals[symbol]:
                        ...
                        if sig.is_waiting():
                            ...
                            exit_sign.pos = sig.exit_triggers()    # long did 'exit_sign. pos', I had exception said exit_sign is not defined, i removed space, still has NameError: name 'exit_sign' is not defined
    ...
    # WebSocketApp required pip3 install webscoket_client, but just import websocket is enough, James 20200714
